const translation = {
  ...
  license: {
    tip: '启动 智定义 社区版之前, 请阅读 GitHub 上的',
    link: '开源协议',
  },
  join: '加入 ',
  joinTipStart: '邀请你加入 ',
  ...
  licenseExpiredTip: '您所在空间的 智定义 Enterprise 许可证已过期，请联系管理员以继续使用 智定义。',
  licenseLost: '许可证丢失',
  licenseLostTip: '无法连接 智定义 许可证服务器，请联系管理员以继续使用 智定义。',
  licenseInactive: '许可证未激活',
  licenseInactiveTip: '您所在空间的 智定义 Enterprise 许可证尚未激活，请联系管理员以继续使用 智定义。',
}
